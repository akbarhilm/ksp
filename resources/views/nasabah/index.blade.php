                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <a rel="tooltip" class="btn btn-success btn-link"
                                                    href="{{ route('nasabah.edit', $n->id_nasabah) }}"
                                                ...
                                                {{-- <a class="btn btn-danger" onclick="return confirm('Hapus anggota?')" href="{{route('nasabah.destroy', $n->id_nasabah)}}"><i class="material-icons">close</i>
                                                    ...
                                                    <a  rel="tooltip" class="btn btn-danger btn-link" href="javascript:{}" onclick="document.getElementById('bts{{$n->id_nasabah}}').click();"  data-original-title="hapus" title="hapus">
                                            ...
                                            <form action="{{ route('nasabah.destroy', $n->id_nasabah) }}" id="deleteform" method="POST"
                                                    onsubmit="return confirm('Hapus anggota?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" style="display: none;" id="bts{{$n->id_nasabah}}"></button>
                                                     </form>
                                        </tr>
                                    @endforeach
