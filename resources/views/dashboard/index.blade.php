<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage='dashboard' menuParent="dashboard"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Dashboard {{$lasttrans}}"></x-navbars.navs.auth>
        <!-- End Navbar -->
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-7">
                                    ...
                                    <p class="text-sm mb-0">
                                        ...
                                        @endphp
                                        <span
                                            class="font-weight-bold ms-1">{{ $lunas }} Pinjaman telah lunas</span>
                                        Bulan Ini
                                    </p>
                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{str_pad($p->id_nasabah,5,'0',STR_PAD_LEFT).' / '.$p->nasabah->nama}}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="progress-wrapper w-75 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">{{$p->pengajuan->kode_resort}}</span>
                                                        </div>
                                                    </div>
