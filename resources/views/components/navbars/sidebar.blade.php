...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">KSP MITRA</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Nasabah</h6>
            </li>
            {{-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'tables' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Bendahara</span>
                </a>
            </li>
            <li class="nav-item">
